...
const copies: Record<UiLocale, AppCopy> = {
  'zh-CN': {
    ...
    modelGate: '模型资产',
    modelGatePending: '首次运行前需要安装本地模型包',
    modelGateChecking: '正在检查浏览器中的模型包',
    modelGateInstalling: '正在下载模型；切到后台会自动暂停',
    modelGateVerifying: '正在校验模型完整性',
    modelGatePaused: '页面进入后台，下载已暂停，可手动继续',
    modelGateFailed: '模型安装失败；已保留可断点续传的部分',
    modelGateReady: '模型已校验并安装到浏览器私有文件系统',
  ...
  'zh-TW': {
    ...
    modelGate: '模型資產',
    modelGatePending: '首次執行前需要安裝本機模型包',
    modelGateChecking: '正在檢查瀏覽器中的模型包',
    modelGateInstalling: '正在下載模型；切到背景會自動暫停',
    modelGateVerifying: '正在驗證模型完整性',
    modelGatePaused: '頁面進入背景，下載已暫停，可手動繼續',
    modelGateFailed: '模型安裝失敗；已保留可斷點續傳的部分',
    modelGateReady: '模型已驗證並安裝到瀏覽器私有檔案系統',
    modelGateProbing: (modelId, completed, total) =>
